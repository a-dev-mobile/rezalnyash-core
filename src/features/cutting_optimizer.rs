...
//                 Panel {
//                     id: tile_dim.id,
//                     width: crate::scaled_math::ScaledNumber::from_u32(tile_dim.width, 0).unwrap_or_else(|_| crate::scaled_math::ScaledNumber::from_u32(0, 0).unwrap()),
//                     height: crate::scaled_math::ScaledNumber::from_u32(tile_dim.height, 0).unwrap_or_else(|_| crate::scaled_math::ScaledNumber::from_u32(0, 0).unwrap()),
...
//             let total_area: i64 = current_solution.placements.len() as i64 * (self.stocks[0].width.to_i64().unwrap_or(0) * self.stocks[0].height.to_i64().unwrap_or(0));
